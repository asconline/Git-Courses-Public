...
var indateFall = new Date("August 26, 2024 00:00:01"); 	// input date
...
var app1 = new Vue({
  ...
  data: {
    ...
    HelpfulLinksHeader:'<p style="text-align: center;"><strong>ASO can be reached 9am-4pm Monday to Friday: 613.533.2470 or <a href="mailto:asc.studentservices@queensu.ca" target="_self">asc.studentservices@queensu.ca</a></strong></p><h2 style="text-align: center;">How can we help?</h2>',
