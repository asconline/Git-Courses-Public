...
var app1 = new Vue({
  ...
  data: {
    ...
    ProctoredFinalExam: '<h5>Exam Centre Location, Eligibility, and Fees</h5><p>Students enrolled exclusively in online courses may choose one of two options to write this course&rsquos proctored assessments:</p><ol><li>You may choose to write the assessments online under supervision of Examity proctoring services. A $100 fee will be charged to your SOLUS account. This fee is known as the <em>Off Campus Exam Admin Fee</em> and is applied in SOLUS at the earlier of: term tuition posting date, or the date at which exam writing method is changed to online. The fee is assessed <strong>once per ASO course with proctored assessments</strong>.</li><li>You may choose to write the assessments in-person on Queen&rsquos campus in Kingston at no additional charge.</li></ol><p>Students enrolled in at least one on-campus course are expected to write this course&rsquos proctored assessments on-campus during the scheduled exam time. They will not be permitted to write this course&rsquos proctored assessments online.</p><p>Students were prompted to indicate their preferred exam writing method when enrolling in the course in SOLUS. The exam writing method may be changed by contacting the ASO Exams Team at <a href="mailto:aso.exams@queensu.ca">aso.exams@queensu.ca</a>.</p><h5>Information for students writing online assessments using Examity</h5><p>Selected assessments in this course will be administered in onQ using online proctoring provided by Examity, a third-party, cloud-based service. This proctoring solution was chosen to support our efforts in maintaining academic integrity when online proctoring is required. Queen&rsquos has conducted an extensive privacy and security review of Examity and has entered into a binding agreement with terms that address the appropriate collection, use and disclosure of personal information in accordance with Ontario&rsquos privacy legislation. To learn more about online proctoring, please see the <a href="https://www.queensu.ca/registrar/academic-info/exams/remote-proctoring" target="_blank">information provided by the Office of the University Registrar</a>.</p><p>If you registered to write online with Examity, all information pertaining to the technical requirements and preparation for writing online will be posted in onQ well in advance of your exam.</p><p>The use of Examity as described is unique to courses offered by the Faculty of Arts and Science Online. Other Faculties use online proctoring solutions in different ways under different regulations. Students should  contact the appropriate Faculty examination team if they have questions.</p><h5>Timing of Final Examinations</h5><p>The exam period dates for each Term are listed on the Faculty of Arts and Science webpage under "<a href="https://www.queensu.ca/artsci/important-dates" target="_blank">Important Dates</a>". Student exam schedules for the Fall Term are posted to SOLUS immediately prior to the Thanksgiving holiday; for the Winter Term they are posted on the Friday before Reading Week, and for the Summer Term they are individually noted on the Arts and Science Online syllabi. Students should not make any travel plans until after the examination schedule has been posted. Exams will not be moved or deferred to accommodate employment, travel/holiday plans or flight reservations. Students experiencing extenuating circumstances preventing them from writing their exams as scheduled should review the <a href="https://www.queensu.ca/artsci/undergrad-students/student-services/academic-consideration-for-students" target="_blank">information about the Academic Consideration process</a>.</p>',
