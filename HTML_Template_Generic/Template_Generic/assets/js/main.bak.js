...
var indateFall = new Date("August 28, 2023 00:00:01"); 	// input date
var fallStart = new Date("September 5, 2023 00:00:01");  // Semester fall start date
...
var app1 = new Vue({
  ...
  data: {
    ...
    Integrity: '</p>Queen&rsquo;s students, faculty, administrators and staff all have responsibilities for upholding the fundamental values of academic integrity: <a href="https://academicintegrity.org/" target="_blank">honesty, trust, fairness, respect, responsibility and courage</a>. hese values are central to the building, nurturing and sustaining of an academic community in which all members of the community will thrive.  These five fundamental values enable instructors, students and staff to contribute to a community of knowledge dedicated to the freedom of inquiry and open exchange of ideas that characterizes the educational environment at Queen&rsquo;s.</p><p>Students are responsible for familiarizing themselves with the <a href="https://www.queensu.ca/secretariat/policies/senate/academic-integrity-procedures-requirements-faculties-schools" target="_blank">Queen&rsquo;s Senate Academic Integrity Procedures</a> and for ensuring that their assignments and their behaviour conform to the principles of academic integrity. Information on academic integrity is available in the Arts and Science Calendar (see <a href="https://www.queensu.ca/academic-calendar/arts-science/academic-regulations/#text" target="_blank">Academic Regulation 1</a>), on the <a href="https://www.queensu.ca/artsci/undergraduate/student-services/academic-integrity" target="_blank">Arts and Science website</a>, and from the instructor of this course. Departures from academic integrity include plagiarism, use of unauthorized materials, facilitation, forgery, falsification, departure from the core values of the University, contract cheating, unauthorized use of Intellectual property, unauthorized collaboration and failure to abide by academic rules. Any behaviour that results in a departure from academic integrity, may be subject to the remedies and sanctions as established by the Queen&rsquo;s University Senate.  Sanctions are meaningful and appropriate to the severity of the departure and ensure that students understand the importance in maintaining the integrity of degrees granted by the University.  The Faculty of Arts and Science is committed to ensuring the Academic Integrity investigation process is fair and supportive and will be carried out in a safe and positive environment. Our intention is that this the academic integrity process will be a learning opportunity promoting student success, growth, and development.</p><p>Queen&rsquo;s <a href="https://sass.queensu.ca/" target="_blank">Student Academic Success Services</a> (SASS) offers a self-directed, online academic integrity module which we encourage all students to take which will help with:</p><ul><li>Understanding the nature of the academic integrity departure</li><li>Understanding the expectations of and role of sources in scholarly writing</li><li>Integrating sources into your writing (paraphrasing, quoting, summarizing)</li><li>Understanding when and how to cite your sources</li><li>Managing your time effectively to avoid the need for shortcuts</li><li>Taking effective notes to ensure accuracy of source material and correct attribution</li></ul>',
