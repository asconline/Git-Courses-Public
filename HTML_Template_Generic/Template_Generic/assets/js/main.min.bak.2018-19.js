...
indateSummer.setDate(6);
indateSummer.setMonth(4); // May
indateSummer.setYear(2019);

// Summer Late (6 weeks)
// note in 2018 the first day of class is a Tuesday due to Canada day
indateLSummer.setDate(1);
indateLSummer.setMonth(6); // July
indateLSummer.setYear(2019);

// exam dates
var examF = "Dec 5-20, 2018";
var examW = "Apr 11-27, 2019";
var examNS1 = "Jun 20-21, 2019";
var examNS2 = "Jul 30 - Aug 2, 2019";
var examS = "Aug 14-15, 2019";
...
/*END of Format Module function*/

/*Changes all LaTex font to 11pt*/
...
/*Opens and Closes all module sections for easy searching with CTRL-F*/
function OpenAll() {
  ...
  document.getElementById("section1").className = "tab-pane fade in active";
	document.getElementById("section2").className = "tab-pane fade in active";
	document.getElementById("section3").className = "tab-pane fade in active";
	document.getElementById("section4").className = "tab-pane fade in active";
	document.getElementById("section5").className = "tab-pane fade in active";
	document.getElementById("section6").className = "tab-pane fade in active";
	document.getElementById("section7").className = "tab-pane fade in active";
	document.getElementById("section8").className = "tab-pane fade in active";
	document.getElementById("section9").className = "tab-pane fade in active";
	document.getElementById("section10").className = "tab-pane fade in active";
	document.getElementById("section11").className = "tab-pane fade in active";
	document.getElementById("section12").className = "tab-pane fade in active";
	document.getElementById("section13").className = "tab-pane fade in active";
	document.getElementById("section14").className = "tab-pane fade in active";
	document.getElementById("section15").className = "tab-pane fade in active";
	document.getElementById("section16").className = "tab-pane fade in active";
	document.getElementById("section17").className = "tab-pane fade in active";
	document.getElementById("section18").className = "tab-pane fade in active";
	document.getElementById("section19").className = "tab-pane fade in active";
	document.getElementById("section20").className = "tab-pane fade in active";
	document.getElementById("section21").className = "tab-pane fade in active";
	document.getElementById("section22").className = "tab-pane fade in active";
	document.getElementById("section23").className = "tab-pane fade in active";
	document.getElementById("section24").className = "tab-pane fade in active";
	document.getElementById("section25").className = "tab-pane fade in active";
	document.getElementById("section26").className = "tab-pane fade in active";
	document.getElementById("section27").className = "tab-pane fade in active";
	document.getElementById("section28").className = "tab-pane fade in active";
	document.getElementById("section29").className = "tab-pane fade in active";
	document.getElementById("section30").className = "tab-pane fade in active";
	document.getElementById("section31").className = "tab-pane fade in active";
	document.getElementById("section32").className = "tab-pane fade in active";
	document.getElementById("section33").className = "tab-pane fade in active";
	document.getElementById("section34").className = "tab-pane fade in active";
	document.getElementById("section35").className = "tab-pane fade in active";
	document.getElementById("section36").className = "tab-pane fade in active";
	document.getElementById("section37").className = "tab-pane fade in active";
	document.getElementById("section38").className = "tab-pane fade in active";
	document.getElementById("section39").className = "tab-pane fade in active";
	document.getElementById("section40").className = "tab-pane fade in active";
	document.getElementById("section41").className = "tab-pane fade in active";
	document.getElementById("section42").className = "tab-pane fade in active";
	document.getElementById("section43").className = "tab-pane fade in active";
	document.getElementById("section44").className = "tab-pane fade in active";
	document.getElementById("section45").className = "tab-pane fade in active";
	document.getElementById("section46").className = "tab-pane fade in active";
	document.getElementById("section47").className = "tab-pane fade in active";
	document.getElementById("section48").className = "tab-pane fade in active";
	document.getElementById("section49").className = "tab-pane fade in active";
	document.getElementById("section50").className = "tab-pane fade in active";
}
...
$('[class="no-print"]').click(function(e)
{
  document.getElementById("OpenSections").style.display = "block";
  document.getElementById("CloseSections").style.display = "none";
  document.getElementById("section1").className = "tab-pane fade in active";
	document.getElementById("section2").classList.remove("in");
	document.getElementById("section3").classList.remove("in");
	document.getElementById("section4").classList.remove("in");
	document.getElementById("section5").classList.remove("in");
	document.getElementById("section6").classList.remove("in");
	document.getElementById("section7").classList.remove("in");
	document.getElementById("section8").classList.remove("in");
	document.getElementById("section9").classList.remove("in");
	document.getElementById("section10").classList.remove("in");
	document.getElementById("section11").classList.remove("in");
	document.getElementById("section12").classList.remove("in");
	document.getElementById("section13").classList.remove("in");
	document.getElementById("section14").classList.remove("in");
	document.getElementById("section15").classList.remove("in");
	document.getElementById("section16").classList.remove("in");
	document.getElementById("section17").classList.remove("in");
	document.getElementById("section18").classList.remove("in");
	document.getElementById("section19").classList.remove("in");
	document.getElementById("section20").classList.remove("in");
	document.getElementById("section21").classList.remove("in");
	document.getElementById("section22").classList.remove("in");
	document.getElementById("section23").classList.remove("in");
	document.getElementById("section24").classList.remove("in");
	document.getElementById("section25").classList.remove("in");
	document.getElementById("section26").classList.remove("in");
	document.getElementById("section27").classList.remove("in");
	document.getElementById("section28").classList.remove("in");
	document.getElementById("section29").classList.remove("in");
	document.getElementById("section30").classList.remove("in");
	document.getElementById("section31").classList.remove("in");
	document.getElementById("section32").classList.remove("in");
	document.getElementById("section33").classList.remove("in");
	document.getElementById("section34").classList.remove("in");
	document.getElementById("section35").classList.remove("in");
	document.getElementById("section36").classList.remove("in");
	document.getElementById("section37").classList.remove("in");
	document.getElementById("section38").classList.remove("in");
	document.getElementById("section39").classList.remove("in");
	document.getElementById("section40").classList.remove("in");
	document.getElementById("section41").classList.remove("in");
	document.getElementById("section42").classList.remove("in");
	document.getElementById("section43").classList.remove("in");
	document.getElementById("section44").classList.remove("in");
	document.getElementById("section45").classList.remove("in");
	document.getElementById("section46").classList.remove("in");
	document.getElementById("section47").classList.remove("in");
	document.getElementById("section48").classList.remove("in");
	document.getElementById("section49").classList.remove("in");
	document.getElementById("section40").classList.remove("in");
	...
	document.getElementById("section9").classList.remove("active");
	document.getElementById("section10").classList.remove("active");
	document.getElementById("section11").classList.remove("active");
	document.getElementById("section12").classList.remove("active");
	document.getElementById("section13").classList.remove("active");
	document.getElementById("section14").classList.remove("active");
	document.getElementById("section15").classList.remove("active");
	document.getElementById("section16").classList.remove("active");
	document.getElementById("section17").classList.remove("active");
	document.getElementById("section18").classList.remove("active");
	document.getElementById("section19").classList.remove("active");
	document.getElementById("section20").classList.remove("active");
	document.getElementById("section21").classList.remove("active");
	document.getElementById("section22").classList.remove("active");
	document.getElementById("section23").classList.remove("active");
	document.getElementById("section24").classList.remove("active");
	document.getElementById("section25").classList.remove("active");
	document.getElementById("section26").classList.remove("active");
	document.getElementById("section27").classList.remove("active");
	document.getElementById("section28").classList.remove("active");
	document.getElementById("section29").classList.remove("active");
	document.getElementById("section30").classList.remove("active");
	document.getElementById("section31").classList.remove("active");
	document.getElementById("section32").classList.remove("active");
	document.getElementById("section33").classList.remove("active");
	document.getElementById("section34").classList.remove("active");
	document.getElementById("section35").classList.remove("active");
	document.getElementById("section36").classList.remove("active");
	document.getElementById("section37").classList.remove("active");
	document.getElementById("section38").classList.remove("active");
	document.getElementById("section39").classList.remove("active");
	document.getElementById("section40").classList.remove("active");
	document.getElementById("section41").classList.remove("active");
	document.getElementById("section42").classList.remove("active");
	document.getElementById("section43").classList.remove("active");
	document.getElementById("section44").classList.remove("active");
	document.getElementById("section45").classList.remove("active");
	document.getElementById("section46").classList.remove("active");
	document.getElementById("section47").classList.remove("active");
	document.getElementById("section48").classList.remove("active");
	document.getElementById("section49").classList.remove("active");
	document.getElementById("section50").classList.remove("active");
  e.preventDefault();
});
/*END of easy CTRL-F search*/
...
var app1 = new Vue({
  ...
  data: {
    ...
    SummerExam: '<div class="row"><div class="col-sm-2"><p><strong>{{ SummerTuitionDue }}</strong></p></div><div class="col-sm-10"><p>Tuition due</p></div></div><div class="row"><div class="col-sm-2"><p><strong>{{ SpringSummerClassesStart }}</strong></p></div><div class="col-sm-10"><p>Classes start</p></div></div><div class="row"><div class="col-sm-2"><p><strong>{{ SummerAdd }}</strong></p></div><div class="col-sm-10"><p>Last day to add courses</p></div></div><div class="row"><div class="col-sm-2"><p><strong>{{ SummerFinDrop }}</strong></p></div><div class="col-sm-10"><p>Last day to drop courses without financial penalty</p></div></div><div class="row"><div class="col-sm-2"><p><strong>{{ SummerAcadDrop }}</strong></p></div><div class="col-sm-10"><p>Last day to drop without academic penalty</p></div></div><div class="row"><div class="col-sm-2"><p><strong>{{ SummerExamCentre }}</strong></p></div><div class="col-sm-10"><p>Last day to change exam centre</p><p>Last day to submit exam accommodation requests (if applicable)</div></div><div class="row"><div class="col-sm-2"><p><strong>{{ SummerClassesEnd }}</strong></p></div><div class="col-sm-10"><p>Classes end</p></div></div><div class="row"><div class="col-sm-2"><p><strong>{{ SummerExams }}</strong></p></div><div class="col-sm-10"><p>Exam Period</p></div></div>',
    ProctoredFinalExam: '<h5>Final Proctored Exam</h5><p>Once the exam schedule has been finalized the exam date will be posted on your SOLUS account. Students living in the Kingston area will write their final exam on Queen&rsquo;s campus. Students writing off campus will receive an email to their Queen&rsquo;s email account with full details of date/time/location of their exam. Please note: off campus exams will be held on the same day as Kingston exams, but the start time may vary slightly due to the requirements of the off-campus exam centre.</p><p>When you registered for the course, you indicated the exam centre location. If you do not remember the exam location you chose, or if you wish to change your exam location, please email: asc.online@queensu.ca or call 613-533-3322. The <a href="http://www.queensu.ca/artsci_online/e-learning/completing-your-course" target="_blank" rel="noopener noreferrer">deadline for changing your exam centre</a> can be found&nbsp;on the Queen&rsquo;s Arts &amp; Science Online website. You must request the change prior to this deadline or you will be subject to a non-refundable administrative fee of $100.00 per exam.</p><h5>Location and Timing of Final Examinations</h5><p>As noted in Academic Regulation 8.2.1, &ldquo;the final examination in any class offered in a term or session (including Summer Term) must be written on the campus on which it was taken, at the end of the appropriate term or session at the time scheduled by the Examinations Office.&rdquo; The exam period is listed in the key dates prior to the start of the academic year in the Faculty of Arts and Science Academic Calendar and on the Office of the University Registrar&rsquo;s webpage. A detailed exam schedule for the Fall Term is posted before the Thanksgiving holiday; for the Winter Term it is posted the Friday before Reading Week, and for the Summer Term the window of dates is noted on the Arts and Science Online syllabus prior to the start of the course. Students should delay finalizing any travel plans until after the examination schedule has been posted. Exams will not be moved or deferred to accommodate employment, travel /holiday plans or flight reservations.</p><h5>Calculator Policy (if applicable)</h5><p>Calculators acceptable for use during quizzes, tests and examinations are intended to support the basic calculating functions required by most Arts and Science courses. For this purpose, the use of the Casio 991 series calculator is permitted and is the only approved calculator for Arts and Science students. This inexpensive calculator sells for around $25 at the Queen&rsquo;s Campus Bookstore, Staples and other popular suppliers of school and office supplies.</p>',
    ...
    Copyright1: 'The material on this website is copyrighted and is for the sole use of students registered in',
    Copyright2: 'The material on this website may be downloaded for a registered student&rsquo;s personal use, but shall not be distributed or disseminated to anyone other than students registered in',
    Copyright3: 'Failure to abide by these conditions is a breach of copyright, and may also constitute a breach of academic integrity under the University Senate&rsquo;s Academic Integrity Policy Statement.</p><p>Course material (for example, course outlines, teaching materials, lectures, PowerPoint slides, drawings, study aids, tests and exams) are copyright-protected works. They are the intellectual property of academic staff like faculty, instructors and teaching assistants (TAs). Academic staff design course materials for your private study. <strong>These materials <em>may not be posted, shared, broadcasted, circulated or otherwise disseminated</em> beyond the confines of the course. Sharing, distributing, or posting course materials to note-sharing websites or providing them to commercial study prep services <em>is not permitted</em></strong>, unless you have obtained the instructor’s or author’s express permission. Unauthorised uses of these materials are an infringement of the author’s copyright and can result in academic sanctions, as a departure from Academic Integrity.',
    ...
    ComputerRequirements: '<div class="row"><div class="col-sm-6"><h4>Microsoft Windows Client</h4><ul><li>Windows 8.1 or newer</li><li>Dual Core 2 GHz processor</li><li>4 GB RAM</li><li>Soundcard with speakers and microphone or preferably a headset</li><li>Webcam</li></ul></div><div class="col-sm-6"><h4>Mac Client</h4><ul><li>OS X 10.13 (High Sierra) or newer</li><li>Dual Core 2 GHz processor</li><li>4 GB RAM</li><li>Internal, USB or external iSight microphone or preferably a headset</li><li>Webcam</li></ul></div></div><div class="row"><div class="col-sm-6"><h4>Supported Browsers</h4><ul><li>Chrome (preferred - latest version)</li><li>Firefox (latest version)</li><li><strong><em>Safari is not recommended as it causes several known issues in onQ</em></strong></li></ul></div><div class="col-sm-6"><h4>Internet Connection</h4><ul><li>Wired high speed access: Cable or better</li><li><strong><em>Wifi is not recommended</em></strong></li></ul></div></div><div class="row"><div class="col-sm-4"><h4>Java</h4><ul><li>Latest version</li></ul></div><div class="col-sm-4"><h4>Media Player</h4><ul><li>Flash (latest version)</li></ul></div><div class="col-sm-4"><h4>Adobe Reader</h4><ul><li>Latest Version</li></ul></div></div>',
    ...
    TimelineHeader: '<div class="row"><div class="col-sm-12 bg-info"><p>The Course Timeline shows all relevant course dates, including assessments, as well as links to other important course information. As dates may change, you should consult the Timeline each time you log in to the course.</p><p>Please note, some students may see an onQ Calendar for their course. However, the onQ calendar does not display all dates associated with your course assignments. For complete information all of your assignments in this course and the start and close dates, please refer to the Course Timeline below.</p><p>If there are discrepancies between dates in the course onQ site, the Timeline will be considered accurate.</p><p>All times are in Kingston time (Eastern).</p></div></div>'
  }
})
...
var app2 = new Vue({
  ...
  data: {
    ...
    FallWinterFallExamCentre: 'Nov 2',
    FallWinterFallExams: 'Dec 5-20',
    FallWinterAcadDrop: 'Mar 1',
    FallWinterWinterExamCentre: 'Mar 7',
    FallWinterClassesEnd: 'Apr 5',
    FallWinterWinterExams: 'Apr 11-27',
    SpringTuitionDue: 'May 1',
    SpringClassesStart: 'May 6',
    SpringAdd: 'May 10',
    SpringFinDrop: 'May 10',
    SpringExamCentre: 'May 17',
    SpringAcadDrop: 'May 31',
    SpringClassesEnd: 'Jun 17',
    SpringExams: 'Jun 20-21',
    SpringSummerTuitionDue: 'May 1',
    SpringSummerClassesStart: 'May 6',
    SpringSummerAdd: 'May 10',
    SpringSummerFinDrop: 'May 17',
    SpringSummerAcadDrop: 'Jun 28',
    SpringSummerExamCentre: 'Jun 28',
    SpringSummerClassesEnd: 'Jul 26',
    SpringSummerExams: 'Jul 30-Aug 2',
    SummerTuitionDue: 'Jul 1',
    SummerClassesStart: 'Jul 2',
    SummerAdd: 'Jul 8',
    SummerFinDrop: 'Jul 8',
    SummerExamCentre: 'Jul 8',
    SummerAcadDrop: 'Jul 29',
    SummerClassesEnd: 'Aug 12',
    SummerExams: 'Aug 14-15'
  }
})
