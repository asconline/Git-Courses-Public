...
// exam dates
var examF = "5 December 2018 - 20 December 2018";
var examW = "11 April 2019 - 27 April 2019";
var examNS1 = "Jun 21-22, 2018";
var examNS2 = "31 July 2018 - 3 August 2018";
...
for(var i = 0; i < 12; i++){ // cycle through weeks
    ...
    monthMon = mvWeekF.toLocaleString("en-us", { month: "long" });
    ...
    monthSun = mvWeekF.toLocaleString("en-us", { month: "long" });

    if ((nmonthSun - nmonthMon) == 0) {
    	arrweekF[i] = dayMon.toString()+ " " + monthMon.toString()+ " " + new Date().getFullYear() +" - " + 	daySun.toString()+ " " + monthMon.toString()+ " " + new Date().getFullYear()+ "\n";
	}
	else{
		arrweekF[i] = dayMon.toString() + " " + monthMon.toString()+ " " + new Date().getFullYear() +" - " + daySun.toString() + " " +monthSun.toString()+ " " + new Date().getFullYear()+ "\n";
	}
    ...
    monthMon = mvWeekW.toLocaleString("en-us", { month: "long" });
    if(i == 11){ // last week of the term ends on a Friday
    ...
    monthSun = mvWeekW.toLocaleString("en-us", { month: "long" });

    if ((nmonthSun - nmonthMon) == 0) {
    	arrweekW[i] = dayMon.toString()+ " " + monthMon.toString()+ " " + new Date().getFullYear() +" - " + 	daySun.toString() + " " + monthMon.toString()+ " " + new Date().getFullYear();
	}
	else{
		arrweekW[i] = dayMon.toString() + " " + monthMon.toString()+ " " + new Date().getFullYear() +" - " + daySun.toString() + " " +monthSun.toString()+ " " + new Date().getFullYear();
	}
    ...
    if(i == 5){
		...
		daySun = mvWeekW.getDate();
        monthSun = mvWeekW.toLocaleString("en-us", { month: "long" });
		readingweek = dayMon.toString() + " " + monthMon.toString()+ " " + new Date().getFullYear() +" - " + 	daySun.toString() + " " + monthMon.toString()+ " " + new Date().getFullYear();
    ...
    monthMon = mvWeekS.toLocaleString("en-us", { month: "long" });
    if(i == 11){ // last week of the term ends on a Friday
    ...
    monthSun = mvWeekS.toLocaleString("en-us", { month: "long" });

    if ((nmonthSun - nmonthMon) == 0) {
    	arrweekS[i] = dayMon.toString()+ " " + monthMon.toString()+ " " + new Date().getFullYear() +" - " + 	daySun.toString()+ " " + monthMon.toString()+ " " + new Date().getFullYear() + "\n";
	}
	else{
		arrweekS[i] = dayMon.toString() + " " + monthMon.toString()+ " " + new Date().getFullYear() +" - " + daySun.toString() + " " +monthSun.toString()+ " " + new Date().getFullYear()+ "\n";
	}
    ...
    if(i<6) // since these are only 6 week courses
    {
    	...
    	monthMon = mvWeekLS.toLocaleString("en-us", { month: "long" });
    	...
    	monthSun = mvWeekLS.toLocaleString("en-us", { month: "long" });

    	if ((nmonthSun - nmonthMon) == 0) {
    		arrweekLS[i] = dayMon.toString()+ " " + monthMon.toString()+ " " + new Date().getFullYear() +" - " + 	daySun.toString()+ " " + monthMon.toString()+ " " + new Date().getFullYear()+ "\n";
		}
		else{
			arrweekLS[i] = dayMon.toString() + " " + monthMon.toString()+ " " + new Date().getFullYear() +" - " + daySun.toString() + " " +monthSun.toString()+ " " + new Date().getFullYear()+ "\n";
		}
	...
	for(var j = 0; j < 7; j++){
        ...
        month = movedateF.toLocaleString("en-us", { month: "long" });
        arrdaysF[i][j] = day.toString() +" "+  month.toString()+ " " + new Date().getFullYear() ;
        ...
        month = movedateW.toLocaleString("en-us", { month: "long" });
        arrdaysW[i][j] = day.toString() +" "+  month.toString()+ " " + new Date().getFullYear();
        ...
        month = movedateS.toLocaleString("en-us", { month: "long" });
        arrdaysS[i][j] = day.toString() +" "+  month.toString() + " " + new Date().getFullYear();
        movedateS.setDate(movedateS.getDate()+1); // increment the day by one

   		//Late Summer Days (6 weeks combined)
        if(i <6){
        	day = movedateLS.getDate();
        	month = movedateLS.toLocaleString("en-us", { month: "long" });
        	arrdaysLS[i][j] = day.toString() +" "+  month.toString()+ " " + new Date().getFullYear();
