/*
The function removes the D2L breadcrumbs on top of the page.
*/
(function() {
$(window.top.document).find(".vui-breadcrumbs").remove();
$(window.top.document).find(".d2l-inline").remove();
})();

window.onload=function ChangeDates() {
// COMMENTS ON USAGE
